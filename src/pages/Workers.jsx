...
export const Workers = () => {
  return (
    <div className="home justify-center flex bg-gray-950">
      <div className="conti-worker">
        <div className="text-center flex flex-wrap">
        <h1 className="text-3xl wlh12 m-auto">Workers</h1>
        </div>
          ...
          {[...Array(10).keys()].map((key) => (
            ...
            >
              <figure className="px-10 pt-10">
                <img src="worker.jpg" alt="Shoes" className="rounded-xl" />
              </figure>
              <div className="card-body items-center text-center">
                <h2 className="card-title">
                  Huan Alvador Sicilius the {key}th
                </h2>
