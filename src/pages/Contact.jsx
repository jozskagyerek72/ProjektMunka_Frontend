...
export const Contact = () => {
  return (
    <div className="min-h-dvh bg-gray-950 flex justify-center items-center flex-col">
      ...
      <div className="card bg-base-100 w-150 h-150 shadow-md shadow-gray-900/50 hover:shadow-lg hover:shadow-gray-900/70 transition-shadow">
          <figure>
            <img src="WL(good).png" alt="WorkLinker inc." className="object-cover"/>
          </figure>
          <div className="card-body bg-gray-800 rounded-b-xl">
            ...
            <div className="card-actions justify-end">
              <div className="badge-primary badge-outline">
               <a href="https://maps.app.goo.gl/Wq98naiyTmkFh9rC6" target="_blank" rel="noopener noreferrer" className="underline text-blue-500 hover:text-blue-700">
